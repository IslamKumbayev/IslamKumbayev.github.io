...
function NavBar() {
    ...
    a.setAttribute("href", "../IslamKumbayev.github.io/pages/history.html");
    li.appendChild(a);
    ul.appendChild(li);
    ...
    a.classList.add("navtex");
    a.setAttribute("href", "../IslamKumbayev.github.io/pages/achievement.html");
    li.appendChild(a);
    ul.appendChild(li);
    ...
    a.innerHTML = "Photos";
    a.classList.add("navtex");
    a.setAttribute("href", "../IslamKumbayev.github.io/pages/photo.html");
    li.appendChild(a);
    ul.appendChild(li);
